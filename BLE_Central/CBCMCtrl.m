...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI {
    if([[advertisementData objectForKey:@"kCBAdvDataLocalName"] isEqual:@"XYZrobot"])
    {
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral {
    ...
    [self.delegate updateCMLog:@"Connection"];
...
//    [self.delegate updateCMLog:[NSString stringWithFormat:@"Disconnected from peripheral: %@ with UUID: %@",peripheral,peripheral.UUID]];
    ...
    [self.delegate updateCMLog:[NSString stringWithFormat:@"UUID=%@",peripheral.UUID]];
    
    [self.delegate updateCMLog:@"Disconnected"];
